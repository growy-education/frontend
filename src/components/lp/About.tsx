...
const BoldTypography = ({ children, ...props }: TypographyProps) => {
  return (
...
const RedBoldTypography = ({ children, ...props }: TypographyProps) => {
  return (
  ...
  return (
    <Box>
      ...
      <Box>
        ...
        <Box p={5}>
          <Typography style={{ textAlign: "left", lineHeight: "1.7rem" }}>
